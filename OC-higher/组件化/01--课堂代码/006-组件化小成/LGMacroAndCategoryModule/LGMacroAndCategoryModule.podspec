...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LGMacroAndCategoryModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/cooci_tz@163.com/LGMacroAndCategoryModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cooci_tz@163.com' => 'cooci_tz@163.com' }
  s.source           = { :git => 'https://github.com/cooci_tz@163.com/LGMacroAndCategoryModule.git', :tag => s.version.to_s }
