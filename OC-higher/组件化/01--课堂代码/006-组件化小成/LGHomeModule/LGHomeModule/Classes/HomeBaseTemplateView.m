...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    HomeBaseTemplateView *view = [[[NSBundle bundleWithPath:bundlePath] loadNibNamed:NSStringFromClass([self class]) owner:self options:nil] lastObject];
...
//    [LGMediator jumpToPlayerVC:self.templateData];
     [[CTMediator sharedInstance] CTMediator_naviagetPlayerVC:((HomeTemplateData *)self.templateData).videoId title:((HomeTemplateData *)self.templateData).title];
}
@end
