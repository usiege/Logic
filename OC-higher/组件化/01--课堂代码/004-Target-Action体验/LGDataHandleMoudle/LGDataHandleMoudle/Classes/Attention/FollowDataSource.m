...
static NSString *const FollowBaseCellStr = @"FollowBaseCell";
static NSString *const FollowImageCellStr = @"FollowImageCell";
static NSString *const FollowVideoCellStr = @"FollowVideoCell";
